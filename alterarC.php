    ...
    <div class="content">
        ...
        if ($id > 0) {
            ...
            if ($conn) {
                ...
                $sql = "SELECT * FROM nutri2 WHERE id = '$id'";
...
<form id="form" method="post" action="alterar2.php">
    ...
    <div class="form-group">
        ...
        <div>
            <label for="imc">Circunferência da Cintura (cm):</label>
            <input type="text" id="cintura" name="cintura" value="<?php echo $cintura; ?>" >
        </div>
        <div>
            <label for="imc">Circunferência do Pescoço (cm):</label>
            <input type="text" id="pescoco" name="pescoco" value="<?php echo $pescoco; ?>" >
        </div>
        <div>
            <label for="imc">Circunferência do Quadril (cm):</label>
            <input type="text" id="quadril" name="quadril" value="<?php echo $quadril; ?>" >
        </div>
        <div>
